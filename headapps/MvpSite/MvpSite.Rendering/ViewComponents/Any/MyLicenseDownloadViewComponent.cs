...
public class MyLicenseDownloadViewComponent : BaseViewComponent
{
    public const string ViewComponentName = "AnyMyLicenseDownload";

    public MyLicenseDownloadViewComponent(IViewModelBinder modelBinder, MvpSelectionsApiClient client)
